...
*** JavaScript
    ...
    #+BEGIN_SRC emacs-lisp
      (req-package js2-mode
        ...
        (bind-key "M-RET" #'js2-line-break js2-mode-map))
    #+END_SRC
*** HTML & Friends
...
*** Markdown
    ...
    Not a language per sé, but whatever.
...
*** smartparens
    ...
    #+BEGIN_SRC emacs-lisp
      (req-package smartparens
        ...
        (bind-key "C-<right>" #'sp-slurp-hybrid-sexp smartparens-strict-mode-map)
        (bind-key "C-k" #'sp-kill-hybrid-sexp smartparens-strict-mode-map))
    #+END_SRC
...
** Blog Org Project
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     <link rel=\"stylesheet\" type=\"text/css\" href=\"../resources/htmlize-solarized-light.css\"/>"
                    ...
                    :html-preamble "<div><a href=\"/\">Home</a> &middot; <a href=\"./\">Blog</a></div>"
                    :html-postamble nil))
   #+END_SRC
